                        ...
                        <div class="row">
                            <div class="col col-lg-5 col-md-5  col-sm-5 col-5">
                                <ul class="profile-menu">
                                    <li>
                                        <a href="/companyProfile/seeprofile/<? echo $compData['0']['idx']?>">정보</a>
                                    </li>
...
<!--                                    </li>-->
                    ...
                    <div class="top-header-author">
                        ...
                        <div class="author-content">
                            <a href="/companyProfile/seeprofile/<? echo $compData['0']['idx'] ?>" class="h4 author-name"><? echo  $compData['0']['compName'] ?></a>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <li>
                                        <div class="career">
                                            ...
                                            <div>
                                                ...
                                                <span class="date"><? echo $projectdata[$i]['projectIntro'] ?></span>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
            ...
            <div class="ui-block">
                ...
                <div class="ui-block-content">
                    ...
                    <ul class="widget w-personal-info">
                        <li>
                            <span class="title">팀 소개 :</span>
                            <span class="text"><? echo $compIntro['0']['introTeam'] ?></span>
                        </li>
                        <li>
                            <span class="title">팀 대표 :</span>
                            <span class="text"><? echo $comprepr['0']['custName'] ?></span>
                        </li>
                        <li>
                            <?php
                                $Startdate = strtotime($compData[$i]['createDate']);
                                $myFormatCreateDate = date("Y.n.j",$Startdate);
                            ?>
                            <span class="title">창설일 :</span>
                            <span class="text"><? echo $myFormatCreateDate ?></span>
                        </li>
<!--                        <li>-->
<!--                            <span class="title">성별 :</span>-->
<!--                            <span class="text">--><?// echo $this->session->custGender ?><!--</span>-->
<!--                        </li>-->
                        <li>
                            <span class="title">이메일 :</span>
                            <a href="mailto:<? echo $compData['0']['compEmail'] ?>" class="text"><? echo $compData['0']['compEmail'] ?></a>
                        </li>
                        <li>
                            <span class="title">웹사이트 :</span>
                            <a href="http://<? echo $compData['0']['homepage'] ?>" target="_blank" class="text"><? echo $compData['0']['homepage'] ?></a>
                        </li>
                        <li>
                            <span class="title">전화번호 :</span>
                            <span class="text"><? echo $compData['0']['compTel'] ?></span>
                        </li>
                    </ul>
