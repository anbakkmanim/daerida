<?php if (
	explode('?', $_SERVER['REQUEST_URI'])[0] != '/member/login' &&
	explode('?', $_SERVER['REQUEST_URI'])[0] != '/hiring/map' &&
	explode('?', $_SERVER['REQUEST_URI'])[0] != '/hiring/resumeSend'
	) { ?>
		...
		<div class="row">
			<div class="col col-lg-12 col-md-12 col-sm-12 col-12">
				<div class="sub-footer-copyright border-0 mt-0">
					<span>
						Copyright <a href="/subpage/about#introteam">안밖마님</a> + <a href="http://gryard.com/">푸른들 소프트</a> All Rights Reserved 2018
					</span>
				</div>
			</div>
		</div>
