<div class="stunning-header bg-primary-opacity">
	...
	<div class="header--standard header--standard-landing animated headroom--top headroom--not-bottom" id="header--standard">
		<div class="container">
			<div class="header--standard-wrap">
				...
				<a href="#" class="open-responsive-menu js-open-responsive-menu">
					<svg class="olymp-menu-icon"><use xlink:href="<?= site_url('assets/#olymp-menu-icon') ?>"></use></svg>
				</a>
	
				<div class="nav nav-pills nav1 header-menu">
					<div class="mCustomScrollbar ps ps--theme_default ps--active-x ps--active-y" data-ps-id="fb9077b8-3b61-5ba7-d178-f024b0b54a3c">
						<ul>
							<li class="nav-item">
							...
							<li class="close-responsive-menu js-close-responsive-menu">
								<svg class="olymp-close-icon"><use xlink:href="<?= site_url('assets/#olymp-close-icon') ?>"></use></svg>
							</li>
							...
							<li class="shoping-cart more">
								<a href="#" class="nav-link">
									<svg class="olymp-shopping-bag-icon"><use xlink:href="<?= site_url('assets/#olymp-shopping-bag-icon') ?>"></use></svg>
										...
										<li class="cart-product-item">
											...
											<div class="product-content">
												...
												<ul class="rait-stars">
													...
													<li>
														<svg class="svg-inline--fa fa-star fa-w-18 star-icon" aria-hidden="true" data-prefix="far" data-icon="star" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg=""><path fill="currentColor" d="M528.1 171.5L382 150.2 316.7 17.8c-11.7-23.6-45.6-23.9-57.4 0L194 150.2 47.9 171.5c-26.2 3.8-36.7 36.1-17.7 54.6l105.7 103-25 145.5c-4.5 26.3 23.2 46 46.4 33.7L288 439.6l130.7 68.7c23.2 12.2 50.9-7.4 46.4-33.7l-25-145.5 105.7-103c19-18.5 8.5-50.8-17.7-54.6zM388.6 312.3l23.7 138.4L288 385.4l-124.3 65.3 23.7-138.4-100.6-98 139-20.2 62.2-126 62.2 126 139 20.2-100.6 98z"></path></svg><!-- <i class="far fa-star star-icon" aria-hidden="true"></i> -->
													</li>
												</ul>
											...
											<div class="more">
												<svg class="olymp-little-delete"><use xlink:href="<?= site_url('assets/#olymp-little-delete') ?>"></use></svg>
											</div>
										</li>
										<li class="cart-product-item">
											<div class="product-thumb">
					...
					<div class="ps__scrollbar-x-rail" style="width: 807px; left: 0px; bottom: 0px;"><div class="ps__scrollbar-x" tabindex="0" style="left: 0px; width: 742px;"></div></div><div class="ps__scrollbar-y-rail" style="top: 0px; height: 73px; right: 0px;"><div class="ps__scrollbar-y" tabindex="0" style="top: 0px; height: 11px;"></div></div></div>
				</div>
			</div>
		</div>
	</div>
