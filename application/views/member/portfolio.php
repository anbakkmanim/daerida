								...
								<div class='photo-album-item-wrap col-4-width'>
									<div class='photo-album-item' data-mh='album-item'>
											<div class='photo-item'>
													<img src='/assets/img/포폴_주.png' alt='photo'>
		...
		<div class="modal-dialog modal-dialog-centered window-popup create-photo-album" role="document">
			<div class="modal-content">
				...
				<form action="/member/delportfolio" method="post" enctype="multipart/form-data">
					...
					<div class="col">
						<input type="button"  class="btn btn-primary btn-lg btn--half-width m-0 mb-2 mr-4" data-dismiss="modal" aria-label="Close" value="확인">
			...
			<div class="modal-body">
				<form action="/member/addcareer" method="post" enctype="multipart/form-data">
					...
					<div class="col">
						...
						<input type="button"  class="btn btn-primary btn-lg btn--half-width  m-0 mb-2" data-dismiss="modal" aria-label="Close" value="취소">
					</div>
				</form>
			</div>
		</div>
