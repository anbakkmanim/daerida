...
<div class="stunning-header bg-primary-opacity">
					...
					<div class="mCustomScrollbar">
						<ul>
							...
							<li class="shoping-cart more">
								<a href="#" class="nav-link">
									<svg class="olymp-shopping-bag-icon"><use xlink:href="<?= site_url('assets/svg-icons/sprites/icons.svg#olymp-shopping-bag-icon') ?>"></use></svg>
	...
	<div class="stunning-header-content">
		<h1 class="stunning-header-title">404 Error Page</h1>
		...
		<div class="row">
			<div class="col col-xl-6 m-auto col-lg-6 col-md-12 col-sm-12 col-12">
				<div class="page-404-content">
					<img src="<?= site_url('assets/img/404.png') ?>" alt="photo">
