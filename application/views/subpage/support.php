			...
			<div class="modal-body">
				<div class="registration-login-form">
					...
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="<?= site_url('assets/#home1') ?>"  role="tab">
						...
						<li class="nav-item">
							<a class="nav-link" data-toggle="tab" href="<?= site_url('assets/#profile1') ?>"  role="tab">
		...
		<div class="row">
			<div class="col col-lg-4 col-md-4 col-sm-6 col-6">
				...
				<div class="widget w-about">
					...
					<a href="<?= site_url('assets/02-ProfilePage.html') ?>"  class="logo">
						<div class="img-wrap">
					...
					<ul class="socials">
						...
						<li>
							<a href="#" >
								<i class="fab fa-google-googleplus-g" aria-hidden="true"></i>
							</a>
						</li>
						<li>
							<a href="#" >
			...
			<div class="col col-lg-12 col-md-12 col-sm-12 col-12">
				...
				<div class="sub-footer-copyright">
					<span>
						Copyright <a href="<?= site_url('assets/index.html') ?>" >Olympus Buddypress + WP</a> All Rights Reserved 2017
					</span>
				</div>
